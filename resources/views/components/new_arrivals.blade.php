<section class="section ec-new-product section-space-p" id="arrivals">
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="{{route('home')}}" class="image">
                                <img class="main-image" src="{{ url('/') }}/frontend/assets/images/product-image/9_1.jpg"
                                    alt="Product" />
                                <img class="hover-image" src="{{ url('/') }}/frontend/assets/images/product-image/9_2.jpg"
                                    alt="Product" />
                            </a>
                            <span class="flags">
                            ...
                            <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                    src="{{ url('/') }}/frontend/assets/images/icons/quickview.svg" class="svg_img pro_svg" alt="" /></a>
                            <div class="ec-pro-actions">
                                <a href="{{route('home')}}" class="ec-btn-group compare" title="Compare"><img
                                        src="{{ url('/') }}/frontend/assets/images/icons/compare.svg" class="svg_img pro_svg" alt="" /></a>
                                <button title="Add To Cart" class="add-to-cart"><img
                                        src="{{ url('/') }}/frontend/assets/images/icons/cart.svg" class="svg_img pro_svg" alt="" /> Add To
                                    Cart</button>
                                <a class="ec-btn-group wishlist" title="Wishlist"><img
                                        src="{{ url('/') }}/frontend/assets/images/icons/wishlist.svg" class="svg_img pro_svg" alt="" /></a>
                            </div>
                        </div>
                    </div>
                    <div class="ec-pro-content">
                        <h5 class="ec-pro-title"><a href="{{route('home')}}">Full Sleeve Cap T-Shirt</a></h5>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="{{route('home')}}" class="image">
                                <img class="main-image" src="{{ url('/') }}/frontend/assets/images/product-image/11_1.jpg"
                                    alt="Product" />
                                <img class="hover-image" src="{{ url('/') }}/frontend/assets/images/product-image/11_2.jpg"
                                    alt="Product" />
                            </a>
                            <span class="flags">
                    ...
                    <div class="ec-pro-content">
                        <h5 class="ec-pro-title"><a href="{{route('home')}}">Classic Leather purse</a></h5>
                        <div class="ec-pro-rating">
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="{{route('home')}}" class="image">
                                <img class="main-image" src="{{ url('/') }}/frontend/assets/images/product-image/12_1.jpg"
                                    alt="Product" />
                                <img class="hover-image" src="{{ url('/') }}/frontend/assets/images/product-image/12_2.jpg"
                                    alt="Product" />
                            </a>
                            ...
                            <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                    src="{{ url('/') }}/frontend/assets/images/icons/quickview.svg" class="svg_img pro_svg" alt="" /></a>
                            <div class="ec-pro-actions">
                                <a href="compare{{route('home')}}" class="ec-btn-group compare" title="Compare"><img
                                        src="{{ url('/') }}/frontend/assets/images/icons/compare.svg" class="svg_img pro_svg" alt="" /></a>
                                <button title="Add To Cart" class="add-to-cart"><img
                                        src="{{ url('/') }}/frontend/assets/images/icons/cart.svg" class="svg_img pro_svg" alt="" /> Add To
                                    Cart</button>
                    ...
                    <div class="ec-pro-content">
                        <h5 class="ec-pro-title"><a href="{{route('home')}}">Fancy Ladies Sandal</a></h5>
                        <div class="ec-pro-rating">
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="flipInY">
                <div class="ec-product-inner">
                    <div class="ec-pro-image-outer">
                        <div class="ec-pro-image">
                            <a href="{{route('home')}}" class="image">
                                <img class="main-image" src="{{ url('/') }}/frontend/assets/images/product-image/13_1.jpg"
                                    alt="Product" />
                                <img class="hover-image" src="{{ url('/') }}/frontend/assets/images/product-image/13_2.jpg"
                                    alt="Product" />
                            </a>
                            <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                    ...
                    <div class="ec-pro-content">
                        <h5 class="ec-pro-title"><a href="{{route('home')}}">Womens Leather Backpack</a></h5>
                        <div class="ec-pro-rating">
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
                            <i class="ecicon eci-star fill"></i>
            ...
            <div class="col-sm-12 shop-all-btn"><a href="{{route('home')}}">Shop All Collection</a>
            </div>
        </div>
    </div>
</section>