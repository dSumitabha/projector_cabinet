                        ...
                        <div class="ec-fs-pro-inner">
                            <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                <div class="ec-fs-pro-image">
                                    <a href="{{route('product_details')}}" class="image"><img class="main-image"
                                            src="{{ url('/') }}/frontend/assets/images/product-image/1_1.jpg" alt="Product" /></a>
                    ...
                    <div class="ec-fs-product">
                        <div class="ec-fs-pro-inner">
                            <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                <div class="ec-fs-pro-image">
                                    <a href="" class="image"><img class="main-image"
                                            src="{{ url('/') }}/frontend/assets/images/product-image/8_1.jpg" alt="Product" /></a>
                                    <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                        data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                            src="{{ url('/') }}/frontend/assets/images/icons/quickview.svg" class="svg_img pro_svg"
                                            alt="" /></a>
                    ...
                    <div class="ec-fs-product">
                        <div class="ec-fs-pro-inner">
                            <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                <div class="ec-fs-pro-image">
                                    <a href="" class="image"><img class="main-image"
                                            src="{{ url('/') }}/frontend/assets/images/product-image/10_1.jpg" alt="Product" /></a>
                                    <a href="#" class="quickview" data-link-action="quickview" title="Quick view"
                                        data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img
                                            src="{{ url('/') }}/frontend/assets/images/icons/quickview.svg" class="svg_img pro_svg"
                                            alt="" /></a>
