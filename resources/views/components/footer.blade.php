            ...
            <div class="container">
                <div class="row">
                    <div class="text-center footer-off-msg">
                        <span>Elevate Your Projection Experience with Our Customized Cabinets!</span><a href="{{route('free_quote')}}" target="_blank">Details & Quote
                            </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="#"><img src="{{ url('/') }}/frontend/assets/images/logo/footer-logo.png"
                                        alt=""><img class="dark-footer-logo" src="{{ url('/') }}/frontend/assets/images/logo/dark-logo.png"
                            ...
                            <div class="ec-footer-links">
                                <ul class="align-items-center">
                                    ...
                                    <li class="ec-footer-link"><span>Production Plant Address (Warehouse):</span>QCR 3278 highway 76 CottonTown TN 37048.</li>
                                    <li class="ec-footer-link"><span>Call Us:</span><a href="tel:+17079219271">+1 7079219271</a></li>
                                    <li class="ec-footer-link"><span>Email:</span><a
                                            href="mailto:praveen.matsa@ustprojectorcabinets.com">praveen.matsa@ustprojectorcabinets.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col text-center footer-copy">
                        <div class="footer-bottom-copy ">
                            <div class="ec-copy">Copyright © 2024 <a class="site-name text-upper"
                                    href="#">Starpact<span>.</span></a>. All Rights Reserved</div>
                        </div>
                    </div>
                    ...
                    <div class="col footer-bottom-right">
                        <div class="footer-bottom-payment d-flex justify-content-end">
                            <div class="payment-link">
                                <img src="{{ url('/') }}/frontend/assets/images/icons/payment.png" alt="">
                            </div>
