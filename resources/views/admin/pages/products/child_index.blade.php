        ...
        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            <div>
                ...
                <p class="breadcrumbs"><span><a href="{{ route('admin.dashboard') }}">Home</a></span>
                    <span><i class="mdi mdi-chevron-right"></i></span>Manage Product Images
                </p>
            </div>
...
<a href="{{ route('admin.products.child_product_images.view', ['id' => $product->product_id]) }}">
    <button type="button" class="btn btn-outline-success"

    style="border-top-left-radius: 0; border-bottom-left-radius: 0;">Manage Images
</button>
</a>
